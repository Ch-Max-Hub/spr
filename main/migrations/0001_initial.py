    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bloc', models.CharField(max_length=20, verbose_name='D/B')),
                ('room', models.CharField(max_length=10, verbose_name='Otag')),
                ('service', models.IntegerField(verbose_name='Hyzmat')),
                ('old_number', models.CharField(max_length=20, verbose_name='Köne nomer')),
